      ...
      <Card className="w-full max-w-md bg-gray-900 border-blue-800/50">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-gray-400">
            Sign in to access premium FiveM resources
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <Tabs defaultValue="login" className="w-full">
            <TabsList className="grid w-full grid-cols-2 bg-black border border-blue-800/50">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 bg-black border-blue-800/50 text-white"
